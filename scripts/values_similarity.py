...
for i, question in enumerate(list(set(df.Question.values))):
    ...
    for j in range(num_completions):
        ...
        # first, get all the premise indices of this conclusion
        conclusions = df[df['Conclusion'] == df.Conclusion.values[i]] #
        premises = conclusions.Premise.values
        ...
        for ii, index in enumerate(indices):
            ...
            cosine_similarities[ii, j] = cosine_similarity
